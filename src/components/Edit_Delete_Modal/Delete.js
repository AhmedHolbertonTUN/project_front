...
const Delete = (props) => {
  ...
  return (
    <div>
      <svg style={{cursor:'pointer'}} onClick={toggle} width="2em" height="1.75em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0v-7z"/>
</svg>
      <Modal isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle}>Delete Item</ModalHeader>
        <ModalBody>
        <form action={`http://localhost:8080/api/cart/delete/${product._id}`} method="post">
        <input className='quantity' type="number" id="quantity" name="quantity" value={quantity} min='1' max='10' style={{display:'none'}} />
        <span>Are you sure yout want to remove "<strong>{product.item}</strong>" from you cart ?</span><br/><br/>
