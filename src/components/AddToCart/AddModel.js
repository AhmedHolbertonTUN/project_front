...
const AddToCart = (props) => {
  ...
  <input type="text" id="supplier" name="supplier" value={product.supplier} style={{display:'none'}} />
  {hidden ? (<p></p>):(<div className='success1'><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
